...
public class UpgradedLearningAlgorithmExperimenter extends LearningAlgorithmExperimenter {
    public UpgradedLearningAlgorithmExperimenter(Environment testEnvironment, int nTrials, int trialLength, LearningAgentFactory... agentFactories) {
    ...
    public void setUpPlottingConfiguration(int chartWidth, int chartHeight, int columns, int maxWindowHeight, TrialMode trialMode, PerformanceMetric... metrics) {
        ...
        this.plotter = new UpgradedPerfomancePlotter(this.agentFactories[0].getAgentName(), chartWidth, chartHeight, columns, maxWindowHeight, trialMode, metrics);
